  ...
  (function(root, factory) {
    ...
    return $.widget('ui.tiler', {
      ...
      goTo: function(tileValue, animation) {
        ...
        if (!$enteringTile.length) {
          return;
        }
        $exitingTile = this.$currentActiveTile;
        if ($enteringTile[0] === this.$currentActiveTile[0]) {
          this._finalizeNewTiles($enteringTile, $exitingTile);
        } else {
      ...
      _setupTiles: function() {
        ...
        if (this.$currentPreviousTile[0] === this.$currentActiveTile[0]) {
          return;
        }
